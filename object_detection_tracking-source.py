...
video_cap = cv2.VideoCapture("/home/nueng/IDS-Videos/01-Original/WW1-6/afternoon/WW1-6 3-13-2024, 3.11.44pm - 3-13-2024, 3.14.51pm.mp4")
writer = create_video_writer(video_cap, "output.mp4")

# Initial Constant Rate Factor for compression quality
crf_value = 23 #41-23-23
fps_value = 12 #16-30-20-30
output_width = 640
output_height = 480 #720x480-640x384-Progressve scan 720-480
object_detected = False
output_file = '/home/nueng/IDS-Videos/02-After-reduceBW/WW1-6-Outputs-re/afternoon/WW1-6 3-13-pm-re.mp4'
...
while True:
    ...
    ffmpeg_cmd[11] = '-r'  #17,11
    ffmpeg_cmd[12] = str(fps_value)  #18,12
    ffmpeg_cmd[17] = '-crf' #13,17
    ffmpeg_cmd[18] = str(crf_value) #14,18
    ...
    # calculate the frame per second and draw it on the frame
    fps_text = f"FPS: {fps_value}" #{1 / (end - start).total_seconds():.2f}
...
csv_filename = "/home/nueng/IDS-Videos/02-After-reduceBW/WW1-6-Outputs-re/afternoon/WW1-6 3-13-pm-re.csv"
